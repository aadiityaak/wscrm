...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Create', href: '/admin/domain-prices/create' },
];
...
const submit = () => {
  form.post('/admin/domain-prices');
};
</script>

<template>
  <Head title="Create Domain Price" />

  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="space-y-6 p-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold tracking-tight">Create Domain Price</h1>
          <p class="text-muted-foreground">Add a new domain extension pricing</p>
        </div>
      </div>
      ...
      <Card class="max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Enter the pricing information for the domain extension
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <div class="flex justify-end space-x-2">
              ...
              <Button type="submit" :disabled="form.processing">
                {{ form.processing ? 'Creating...' : 'Create Domain Price' }}
              </Button>
            </div>
          </form>
        </CardContent>
