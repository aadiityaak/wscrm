...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Bulanan', href: '/admin/expenses/monthly' },
];
...
const totalMonthly = props.expenses
...
<template>
    <Head title="Pengeluaran Bulanan" />
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">Kelola pengeluaran bulanan seperti lisensi software dan layanan</p>
                </div>
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle class="text-sm font-medium">Total Bulanan</CardTitle>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Daftar Pengeluaran Bulanan</CardTitle>
                    <CardDescription>
                        Kelola semua pengeluaran bulanan untuk layanan dan lisensi
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
